...
import unrealEngine from './images/unreal engine.png';
...
const projects = [
    {
        ...
        description: 'A pepsi product launch / showcase project made with Blender 3D',
        toolsUsed: [
            {
                name: 'Blender 3D', img: blender
            },
            {
                name: 'HitFilm Express', img: hitfilm
            }
        ],
